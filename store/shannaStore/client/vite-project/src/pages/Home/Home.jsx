...
const Home = () => {
  ...
  const { addItem, addToCart, cartItems, dispatch,saveCartToBackend, fetchCart,updateCartItemQuantity } = useContext(CartContext);
...
console.log("Existing item in cart:",existingItem ? existingItem.productId : "Not found");
